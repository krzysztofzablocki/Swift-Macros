...
- [Swift Macros](https://github.com/bernndr/swift-macros): Contains a collection of useful macros:
  ...
  - More to come...
- [Migrator]([https://github.com/bernndr/swift-macros](https://github.com/narek-sv/Migrator): Migrator is a versatile Swift Package designed to streamline the execution of asynchronous tasks with dependency management on all Apple platforms. The packgae also includes a handy macro for semantic verionins ([SemVer 2.0.0](https://semver.org/)).
