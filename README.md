...
- [swift-mocking](https://github.com/DanielCardonaRojas/swift-mocking) A compact macro powered by parameter packs that provides mock objects for your protocols and a Mockito-style API.
